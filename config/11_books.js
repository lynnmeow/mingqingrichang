...
window.YLT_CFG.books = [
  { id: "b_daode", name: "《道德经》", desc: "春秋·老聃撰，五千言分道经、德经八十一章，道家根本经典。", cat: "misc", author: "老聃", dynasty: "春秋",
    chapters: [] },
  { id: "b_shi", name: "《诗经选》", desc: "诗三百，思无邪。", cat: "poem", author: "佚名", dynasty: "先秦",
    chapters: [
      { n: 1, text: "《周南·关雎》\n关关雎鸠，在河之洲。窈窕淑女，君子好逑。\n参差荇菜，左右流之。窈窕淑女，寤寐求之。\n求之不得，寤寐思服。悠哉悠哉，辗转反侧。\n参差荇菜，左右采之。窈窕淑女，琴瑟友之。\n参差荇菜，左右芼之。窈窕淑女，钟鼓乐之。" },
      { n: 2, text: "《周南·桃夭》\n桃之夭夭，灼灼其华。之子于归，宜其室家。\n桃之夭夭，有蕡其实。之子于归，宜其家室。\n桃之夭夭，其叶蓁蓁。之子于归，宜其家人。" },
  ...
  { id: "b_poem08", name: "《李商隐集》", desc: "唐·李商隐 诗词辑录。", cat: "poem", author: "李商隐", dynasty: "唐",
    chapters: [
      { n: 1, text: "《登乐游原》\n向晚意不适，驱车登古原。\n夕阳无限好，只是近黄昏。" },
      { n: 2, text: "《夜雨寄北》\n君问归期未有期，巴山夜雨涨秋池。\n何当共剪西窗烛，却话巴山夜雨时。" },
      { n: 3, text: "《无题·相见时难别亦难》\n相见时难别亦难，东风无力百花残。\n春蚕到死丝方尽，蜡炬成灰泪始干。\n晓镜但愁云鬓改，夜吟应觉月光寒。\n蓬山此去无多路，青鸟殷勤为探看。" },
  ...
  { id: "b_poem09", name: "《李贺集》", desc: "唐·李贺 诗词辑录。", cat: "poem", author: "李贺", dynasty: "唐",
    chapters: [
  ...
  { id: "b_pingshi", name: "《瓶史》", desc: "明·袁宏道撰，瓶花清供之谱，论瓶花之宜、忌、法，列可瓶之花目。", cat: "misc", author: "袁宏道", dynasty: "明",
    chapters: [
      { n: 1, text: "夫幽人韵士，屏绝声色，其嗜好不得不钟于山水花竹。夫山水花竹者，名之所不在，奔竞之所不至也。天下之人，栖止于嚣崖利薮，目眯尘沙，心疲计算，欲有之而有所不暇，故幽人韵士得以乘间而据为一日之有。夫幽人韵士者，处于不争之地，而以一切让天下之人者也；惟夫山水花竹；欲以让人，而人未必乐受，故居之也安，而据之也无祸。嗟夫，此隐者之事，决烈丈夫之所为，余生平企羡而不可必得者也。幸而身居隐见之间，世间可趋可争者既不到，余遂欲欹笠高岩，濯缨流水，又为卑官所绊，仅有栽花莳竹一事，可以自乐。而邸居湫隘，迁徒无常，不得已乃以胆瓶贮花，随时插换。京师人家所有名卉，一旦遂为余案头物，无扞剔浇顿之苦，而有味赏之乐，取者不贪，遇者不争，是可述也。噫，此暂时快心事也，无狃以为常，而忘山水之大乐。石公记之。凡瓶中所有品目,条列于后，与诸好事而贫者共焉。" },
  ...
  { id: "b_poem12", name: "《古诗源 选》", desc: "清·沈德潜 辑，古诗总集，上起古逸、下逮隋代，风骚以来诗之渊源所自。", cat: "poem", author: "沈德潜（清）辑", dynasty: "历",
    chapters: [
      { n: 1, text: "〔汉·佚名〕《古诗十九首·行行重行行》\n行行重行行，与君生别离。\n相去万余里，各在天一涯。\n道路阻且长，会面安可知？\n胡马依北风，越鸟巢南枝。\n相去日已远，衣带日已缓。\n浮云蔽白日，游子不顾返。\n思君令人老，岁月忽已晚。\n弃捐勿复道，努力加餐饭。" },
      { n: 2, text: "〔汉·佚名〕《古诗十九首·涉江采芙蓉》\n涉江采芙蓉，兰泽多芳草。\n采之欲遗谁？所思在远道。\n还顾望旧乡，长路漫浩浩。\n同心而离居，忧伤以终老。" },
      { n: 3, text: "〔汉·佚名〕《古诗十九首·迢迢牵牛星》\n迢迢牵牛星，皎皎河汉女。\n纤纤擢素手，札札弄机杼。\n终日不成章，泣涕零如雨。\n河汉清且浅，相去复几许？\n盈盈一水间，脉脉不得语。" },
      { n: 4, text: "〔汉·佚名〕《汉乐府·江南》\n江南可采莲，莲叶何田田。\n鱼戏莲叶间。\n鱼戏莲叶东，鱼戏莲叶西，\n鱼戏莲叶南，鱼戏莲叶北。" },
      { n: 5, text: "〔汉·佚名〕《汉乐府·长歌行》\n青青园中葵，朝露待日晞。\n阳春布德泽，万物生光辉。\n常恐秋节至，焜黄华叶衰。\n百川东到海，何时复西归？\n少壮不努力，老大徒伤悲。" },
      { n: 6, text: "〔汉·佚名〕《汉乐府·上邪》\n上邪！我欲与君相知，长命无绝衰。\n山无陵，江水为竭，冬雷震震，夏雨雪，\n天地合，乃敢与君绝！" },
      { n: 7, text: "〔三国·曹操〕《观沧海》\n东临碣石，以观沧海。\n水何澹澹，山岛竦峙。\n树木丛生，百草丰茂。\n秋风萧瑟，洪波涌起。\n日月之行，若出其中；\n星汉灿烂，若出其里。\n幸甚至哉，歌以咏志。" },
      { n: 8, text: "〔晋·陶渊明〕《饮酒·结庐在人境》\n结庐在人境，而无车马喧。\n问君何能尔？心远地自偏。\n采菊东篱下，悠然见南山。\n山气日夕佳，飞鸟相与还。\n此中有真意，欲辨已忘言。" }
    ] },
